...
import { FaAmbulance, FaMapMarkerAlt, FaClock, FaPhoneAlt } from "react-icons/fa";
...
const AmbulanceForm = () => {
  ...
  return (
    ...
    <div className="ambulance-container">
      ...
      <img src={images.BookAmbulance} alt="Ambulance Illustration" style={{ width: '40%', borderRadius: '20px', paddingRight: "100px" }} />
    </div>
  );
};
